...
SAMPLES_KEY = 'trade_samples.json'
OUTPUT_KEY = 'heuristics_optimized.json'
FUND_KEY = 'fund_heuristics.json'
...
def load_samples():
    samples = store_load(SAMPLES_KEY, None)
    if not samples:
        return []
    return samples
...
def main():
    ...
    store_save(FUND_KEY, fund_payload)
    print(f'Wrote {FUND_KEY}')
